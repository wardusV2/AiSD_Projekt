...
struct KierunekTeksturyDlaCzolgu
{
    Texture2D direction;
};
...
struct tank
{
    ...
    Texture2D KierunekCzolgu;
};

struct MenuTekstury
{
    Texture2D MenuTlo, MenuTloNachodzace;
    Texture2D tank_1;
...
* @param TeksturyDlaAnimacjiPocisku *TeksturaWybuchu
* @return Funkcja nie zwraca wartosci
*/
struct TeksturyDlaAnimacjiPocisku
{
    Texture2D stage_1;
    Texture2D stage_2;
    Texture2D stage_3;
...
* @param TeksturyDlaAnimacjiPocisku explosion_animation - grafika animacji ekspolzji
* @param index
* @return Funkcja nie zwraca wartosci
*/
void RysowanieAnimacjiEksplozji(struct animation_data *animation, struct TeksturyDlaAnimacjiPocisku explosion_animation, int index);
/** \brief funkcja wczytujaca grafike eksplozji
* @param TeksturyDlaAnimacjiPocisku *TeksturaWybuchu
* @return Funkcja nie zwraca wartosci
*/
void WczytywanieGrafikeEkspolzji(struct TeksturyDlaAnimacjiPocisku *TeksturaWybuchu);

/** \brief funkcja usuwajaca z pamieci grafike eksplozji
* @param TeksturyDlaAnimacjiPocisku *TeksturaWybuchu - grafika animacji ekspolzji
* @return Funkcja nie zwraca wartosci
*/
void ZwolnienieGrafikiEkspolzji(struct TeksturyDlaAnimacjiPocisku *TeksturaWybuchu);
...
void TworzenieModeliKolizjiScian(struct ScianaNaMapie *walls, struct kwadrat pola_siatki[][NETSIZE_X]);
...
void RysowanieModeluKolizjiScian(struct ScianaNaMapie *walls, int walls_number);
...
* @return Funkcja nie zwraca wartosci
*/
bool SprawdzKolizjeZKrawedziamiMapy(Rectangle *collision_model);
...
* @return Funkcja nie zwraca wartosci
*/
bool SprawdzKolizjeZeSciana(Rectangle tank_collision_model, int speed, int direction, struct ScianaNaMapie *walls, int walls_number);
...
* @return Funkcja nie zwraca wartosci
*/
bool SprawdzKolizjeZPrzeciwnikiem(struct tank *enemies, int speed, int direction, int which_tank, Rectangle tank_collision_model, Rectangle player_collision_model);
...
* @return Funkcja nie zwraca wartosci
*/
int SprawdzKolizjePociskuZeScianami(Rectangle bullet_collision_model, struct ScianaNaMapie *walls, int walls_number);
...
* @return Funkcja nie zwraca wartosci
*/
bool SprawdzKolizjePociskuZPrzeciwnikiem(Rectangle bullet_collision_model, struct tank *enemies, int *tank_destroyed_x, int *tank_destroyed_y, struct bonus_data *bonuses);
...
* @param MenuTekstury *menu
* @return Funkcja nie zwraca wartosci
*/
void loadMenuTextures(struct MenuTekstury *menu);
/** \brief funkcja wczytujaca grafike pod koniec gry
* @param TekturaKoncaGry *end_window - grafika ekranu koncowego
* @return Funkcja nie zwraca wartosci
*/
void load_end_window(struct TekturaKoncaGry *end_window);
/** \brief funkcja usuwajaca grafike menu z pamieci
* @param MenuTekstury *menu - grafika menu
* @return Funkcja nie zwraca wartosci
*/
void unloadMenuTextures(struct MenuTekstury *menu);
/** \brief funkcja usuwajaca grafike pod koniec gry z pamieci
* @param TekturaKoncaGry *end_window - grafika ekranu koncowego
* @return Funkcja nie zwraca wartosci
*/
void unload_end_window_textures(struct TekturaKoncaGry *end_window);
/** \brief funkcja wyswietlajaca animacje w menu
* @param MenuTekstury *menu - grafika menu
* @return Funkcja nie zwraca wartosci
*/
void drawAnimatedMenu(struct MenuTekstury *menu);
/** \brief funkcja wyswietlajaca grafike wygrales pod koniec gry
* @param TekturaKoncaGry end_window - grafika ekranu koncowego
* @return Funkcja nie zwraca wartosci
*/
bool draw_win_end_window(struct TekturaKoncaGry end_window);
/** \brief funkcja wyswietlajaca grafike przegrales pod koniec gry
* @param TekturaKoncaGry end_window - grafika ekranu koncowego
* @param tank player - czolg gracza
* @return Funkcja nie zwraca wartosci
*/
bool draw_lose_end_window(struct TekturaKoncaGry end_window, struct tank player);
...
* @param KierunekTeksturyDlaCzolgu *player_positions - grafika kierunku czolgu gracza
* @param choice - wybor
* @return Funkcja nie zwraca wartosci
*/
// funkcja wczytuje textury pozycji czaolgu do tablicy 4 - elementowej, ktora bedzie je przechowywac
void load_tank_textures(struct KierunekTeksturyDlaCzolgu *player_positions, int choice);
/** \brief funkcja podmienia tekstury gracza lub przeciwnikow ze wzgledu na kierunek poruszania sie
* @param KierunekTeksturyDlaCzolgu *positions - grafika kierunku czolgu
* @param Texture2D *KierunekCzolgu - grafika 2D kierunku czolgu
* @param direction - kierunek
* @return Funkcja nie zwraca wartosci
*/
// funkcja podmienia tekstury gracza lub przeciwnikow ze wzgledu na kierunek poruszania sie
void change_tank_textures(struct KierunekTeksturyDlaCzolgu *positions, Texture2D *KierunekCzolgu, int direction);
...
void addPlayer(struct tank *player, struct KierunekTeksturyDlaCzolgu *player_positions);
/** \brief inicjacja parametrow przeciwnikow
* @param tank *enemies - czolg gracza
* @param KierunekTeksturyDlaCzolgu *enemy_positions - grafika kierunku czolgu przeciwnika
* @return Funkcja nie zwraca wartosci
*/
// inicjacja parametrow przeciwnikow
void addEnemy(struct tank *enemies, struct KierunekTeksturyDlaCzolgu *enemy_positions);
...
* @param KierunekTeksturyDlaCzolgu *enemy_positions
* @param tank *enemies - czolg przeciwnika
* @param ScianaNaMapie *walls - sciany
* @param walls_number - numer sciany
...
* @return Funkcja nie zwraca wartosci
*/
void enemyMovements(struct KierunekTeksturyDlaCzolgu *enemy_positions, struct tank *enemies, struct ScianaNaMapie *walls, int walls_number, Rectangle player);
/** \brief funkcja odpowiadajaca za wczytywanie bonusow
* @param TeksturaBonusu *TeksturaBonusu - grafika bonusu
* @return Funkcja nie zwraca wartosci
*/
void load_bonus_textures(struct TeksturaBonusu *TeksturaBonusu);
/** \brief funkcja odpowiadajaca za usuwanie z pamieci bonusow
* @param TeksturaBonusu *TeksturaBonusu - grafika bonusu
* @return Funkcja nie zwraca wartosci
*/
void unload_bonus_textures(struct TeksturaBonusu *TeksturaBonusu);
...
* @return Funkcja nie zwraca wartosci
*/
void draw_bonuses(struct TeksturaBonusu *TeksturaBonusu, struct bonus_data *bonuses);
...
int main(void)
{
    ...
    struct KierunekTeksturyDlaCzolgu player_positions[4]; // tworzenie struktury przechowujacej textury pozycji czolgu gracza
    struct KierunekTeksturyDlaCzolgu enemy_positions[4];  // tworzenie struktury przechowujacej textury pozycji czolgow przeciwnikow
    ...
    struct MenuTekstury menu;
    loadMenuTextures(&menu);
    struct TekturaKoncaGry end_window;
    ...
    struct TeksturyDlaAnimacjiPocisku TeksturaWybuchu;
    struct TeksturaBonusu TeksturaBonusu;
    ...
    while (!WindowShouldClose()) // Okno gry bedzie otwarte do czasu nacisniecia klawisza ESC lub przycisku zamykajacego okno
    {
        while (gamemode == MAIN_MENU) // wyswietlanie menu
        {
            ...
            else
            {
                ...
                UnloadTexture(player.KierunekCzolgu);
                ...
                ZwolnienieGrafikiEkspolzji(&TeksturaWybuchu);

                unload_bonus_textures(&TeksturaBonusu);
                CloseAudioDevice();
                CloseWindow();
        ...
        while (gamemode == GAME)
        {
            ...
            if (!is_game_loaded || map_loaded != which_map) // osbluga rozpoczecia gry
            {
                ...
                if (walls == NULL)
                    return 0;
                TworzenieModeliKolizjiScian(walls, pola_siatki); // tworzenie modeli kolizyjnych scian
                ...
                WczytywanieGrafikeEkspolzji(&TeksturaWybuchu);

                load_bonus_textures(&TeksturaBonusu);
            ...
            if (!WindowShouldClose())
            {
                ...
                if (IsKeyDown(KEY_D) && !SprawdzKolizjeZeSciana(player.tank_collision_model, player.speed, RIGHT, walls, walls_number) && !checkCollisionBetweenPlayerAndOtherTanks(enemies, player.speed, RIGHT, player.tank_collision_model)) // ruch w prawo
                {
                    player.direction = RIGHT;
                    player.x = player.tank_collision_model.x += player.speed;
                    if (IsKeyPressed(KEY_D) || (IsKeyReleased(KEY_W) || IsKeyReleased(KEY_S)))
                        change_tank_textures(player_positions, &player.KierunekCzolgu, RIGHT);
                }
                if (IsKeyDown(KEY_A) && !SprawdzKolizjeZeSciana(player.tank_collision_model, player.speed, LEFT, walls, walls_number) && !checkCollisionBetweenPlayerAndOtherTanks(enemies, player.speed, LEFT, player.tank_collision_model)) // ruch w lewo
                {
                    player.direction = LEFT;
                    player.x = player.tank_collision_model.x -= player.speed;
                    if (IsKeyPressed(KEY_A) || (IsKeyReleased(KEY_W) || IsKeyReleased(KEY_S)))
                        change_tank_textures(player_positions, &player.KierunekCzolgu, LEFT);
                }
                if (IsKeyDown(KEY_W) && !SprawdzKolizjeZeSciana(player.tank_collision_model, player.speed, UP, walls, walls_number) && !checkCollisionBetweenPlayerAndOtherTanks(enemies, player.speed, UP, player.tank_collision_model)) // ruch w gore
                {
                    player.direction = UP;
                    player.y = player.tank_collision_model.y -= player.speed;
                    if (IsKeyPressed(KEY_W) || (IsKeyReleased(KEY_D) || IsKeyReleased(KEY_A)))
                        change_tank_textures(player_positions, &player.KierunekCzolgu, UP);
                }
                if (IsKeyDown(KEY_S) && !SprawdzKolizjeZeSciana(player.tank_collision_model, player.speed, DOWN, walls, walls_number) && !checkCollisionBetweenPlayerAndOtherTanks(enemies, player.speed, DOWN, player.tank_collision_model)) // ruch w dol
                {
                    player.direction = DOWN;
                    player.y = player.tank_collision_model.y += player.speed;
                    if (IsKeyPressed(KEY_S) || (IsKeyReleased(KEY_D) || IsKeyReleased(KEY_A)))
                        change_tank_textures(player_positions, &player.KierunekCzolgu, DOWN);
                }
                //---------------------------------------------------------------------
                ...
                if (player.lives > 0)
                    DrawTextureEx(player.KierunekCzolgu, (Vector2){player.x, player.y}, 0, 1, RAYWHITE); // rysowanie textury gracza
                drawEnemies(enemies);
                ...
                draw_bonuses(&TeksturaBonusu, bonuses);
                ...
                for (i = 0; i < ANIMATION_ARRAY_SIZE; i++)
                    ...
                    {
                        RysowanieAnimacjiEksplozji(explosion_animations, TeksturaWybuchu, i);
                    }
...
void WczytywanieGrafikeEkspolzji(struct TeksturyDlaAnimacjiPocisku *TeksturaWybuchu)
{
    ...
    TeksturaWybuchu->stage_1 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){50, 0, 50, 50});
    TeksturaWybuchu->stage_2 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){100, 0, 50, 50});
    TeksturaWybuchu->stage_3 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){150, 0, 50, 50});
    TeksturaWybuchu->stage_4 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){200, 0, 50, 50});
    TeksturaWybuchu->stage_5 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){250, 0, 50, 50});
    TeksturaWybuchu->stage_6 = LoadTextureFromImage(tmp);

    tmp = ImageFromImage(explosion_texture, (Rectangle){300, 0, 50, 50});
    TeksturaWybuchu->stage_7 = LoadTextureFromImage(tmp);
}

void ZwolnienieGrafikiEkspolzji(struct TeksturyDlaAnimacjiPocisku *TeksturaWybuchu)
{
    UnloadTexture(TeksturaWybuchu->stage_1);
    UnloadTexture(TeksturaWybuchu->stage_2);
    UnloadTexture(TeksturaWybuchu->stage_3);
    UnloadTexture(TeksturaWybuchu->stage_4);
    UnloadTexture(TeksturaWybuchu->stage_5);
    UnloadTexture(TeksturaWybuchu->stage_6);
    UnloadTexture(TeksturaWybuchu->stage_7);
}
...
void loadMenuTextures(struct MenuTekstury *menu)
{
    ...
    menu->MenuTlo = LoadTexture("img/MenuTlo.png");
    menu->MenuTloNachodzace = LoadTexture("img/MenuTloNachodz.png");
...
void unloadMenuTextures(struct MenuTekstury *menu)
{
    ...
    UnloadTexture(menu->MenuTlo);
    UnloadTexture(menu->MenuTloNachodzace);
}
...
{
    BeginDrawing();
    DrawTexture(menu->MenuTlo, 0, 0, RAYWHITE);
    DrawTexture(menu->MenuTloNachodzace, 0, 200, RAYWHITE);
...
void change_tank_textures(struct KierunekTeksturyDlaCzolgu *positions, Texture2D *KierunekCzolgu, int direction)
{
    ...
    {
    case DOWN:
        *KierunekCzolgu = positions[0].direction;
        break;
    case LEFT:
        *KierunekCzolgu = positions[1].direction;
        break;
    case RIGHT:
        *KierunekCzolgu = positions[2].direction;
        break;
    case UP:
        *KierunekCzolgu = positions[3].direction;
        break;
    default:
        *KierunekCzolgu = positions[0].direction;
        break;
...
void addPlayer(struct tank *player, struct KierunekTeksturyDlaCzolgu *player_positions)
{
    ...
    player->KierunekCzolgu = player_positions[0].direction;
}
...
void addEnemy(struct tank *enemies, struct KierunekTeksturyDlaCzolgu *enemy_positions)
{
    ...
    for (i = 0; i < NUMBER_OF_ENEMIES; i++)
    {
        ...
        enemies[i].KierunekCzolgu = enemy_positions[0].direction;
    }
}
...
void unloadEnemyTextures(struct tank *enemies)
{
    int i;
    for (i = 0; i < NUMBER_OF_ENEMIES; i++)
        UnloadTexture(enemies[i].KierunekCzolgu);
}
...
void drawEnemies(struct tank *enemies)
{
    ...
    for (i = 0; i < NUMBER_OF_ENEMIES; i++)
        if (enemies[i].lives > 0)
            DrawTextureEx(enemies[i].KierunekCzolgu, (Vector2){enemies[i].x, enemies[i].y}, 0, 1, RAYWHITE);
}
...
void enemyMovements(struct KierunekTeksturyDlaCzolgu *enemy_positions, struct tank *enemies, struct ScianaNaMapie *walls, int walls_number, Rectangle player)
{
    ...
    for (i = 0; i < NUMBER_OF_ENEMIES; i++)
    {
        ...
        {
        case LEFT:
            if (!SprawdzKolizjeZeSciana(enemies[i].tank_collision_model, enemies[i].speed, LEFT, walls, walls_number) &&
                !SprawdzKolizjeZPrzeciwnikiem(enemies, enemies[i].speed, LEFT, i, enemies[i].tank_collision_model, player) && enemies[i].movement_counter != 30)
            {
                change_tank_textures(enemy_positions, &enemies[i].KierunekCzolgu, LEFT);
            ...
            break;
        case RIGHT:
            if (!SprawdzKolizjeZeSciana(enemies[i].tank_collision_model, enemies[i].speed, RIGHT, walls, walls_number) &&
                !SprawdzKolizjeZPrzeciwnikiem(enemies, enemies[i].speed, RIGHT, i, enemies[i].tank_collision_model, player) && enemies[i].movement_counter != 30)
            {
                change_tank_textures(enemy_positions, &enemies[i].KierunekCzolgu, RIGHT);
                enemies[i].tank_collision_model.x += enemies[i].speed;
                enemies[i].x += enemies[i].speed;
                enemies[i].movement_counter++;
            }
            ...
            break;
        case DOWN:
            if (!SprawdzKolizjeZeSciana(enemies[i].tank_collision_model, enemies[i].speed, DOWN, walls, walls_number) &&
                !SprawdzKolizjeZPrzeciwnikiem(enemies, enemies[i].speed, DOWN, i, enemies[i].tank_collision_model, player) && enemies[i].movement_counter != 30)
            {
                change_tank_textures(enemy_positions, &enemies[i].KierunekCzolgu, DOWN);
            ...
            break;
        case UP:
            if (!SprawdzKolizjeZeSciana(enemies[i].tank_collision_model, enemies[i].speed, UP, walls, walls_number) &&
                !SprawdzKolizjeZPrzeciwnikiem(enemies, enemies[i].speed, DOWN, i, enemies[i].tank_collision_model, player) && enemies[i].movement_counter != 30)
            {
                change_tank_textures(enemy_positions, &enemies[i].KierunekCzolgu, UP);
                enemies[i].tank_collision_model.y -= enemies[i].speed;
                enemies[i].y -= enemies[i].speed;
                enemies[i].movement_counter++;
            }
...
void load_bonus_textures(struct TeksturaBonusu *TeksturaBonusu)
{
    TeksturaBonusu->extra_life_texture = LoadTexture("img/DodatkoweZycie.png");
    TeksturaBonusu->extra_speed_texture = LoadTexture("img/ZwiekszonaPredkosc.png");
}

void unload_bonus_textures(struct TeksturaBonusu *TeksturaBonusu)
{
    UnloadTexture(TeksturaBonusu->extra_life_texture);
    UnloadTexture(TeksturaBonusu->extra_speed_texture);
}
...
void draw_bonuses(struct TeksturaBonusu *TeksturaBonusu, struct bonus_data *bonuses)
{
    ...
    for (i = 0; i < NUMBER_OF_ENEMIES; i++)
        if (bonuses[i].is_used == true)
        {
            ...
            {
            case EXTRA_LIFE:
                DrawTexture(TeksturaBonusu->extra_life_texture, bonuses[i].bonus_collision_mode.x, bonuses[i].bonus_collision_mode.y, RAYWHITE);
                break;
            case EXTRA_SPEED:
                DrawTexture(TeksturaBonusu->extra_speed_texture, bonuses[i].bonus_collision_mode.x, bonuses[i].bonus_collision_mode.y, RAYWHITE);
                break;
            default:
                break;
            }
                    ...
                    int walls_number, struct tank *player, struct tank *enemies, struct animation_data *explosion_animations, struct bonus_data *bonuses)
{
    ...
    for (i = 0; i < BULLETS_NUMBER; i++)
    {
        ...
        {
            is_collision_with_enemy = SprawdzKolizjePociskuZPrzeciwnikiem(player_bullet[i].bullet_collision_model, enemies, &tank_destroyed_x, &tank_destroyed_y, bonuses);
            which_wall = SprawdzKolizjePociskuZeScianami(player_bullet[i].bullet_collision_model, walls, walls_number);
            ...
            if (SprawdzKolizjeZKrawedziamiMapy(&player_bullet[i].bullet_collision_model))
            {
                player_bullet[i].is_used = false;
                player_bullet[i].bullet_collision_model.x = player_bullet[i].bullet_collision_model.y = -100;
            }
        ...
        {
            which_wall = SprawdzKolizjePociskuZeScianami(enemy_bullet[i].bullet_collision_model, walls, walls_number);
            ...
            if (SprawdzKolizjeZKrawedziamiMapy(&enemy_bullet[i].bullet_collision_model))
            {
                enemy_bullet[i].is_used = false;
                enemy_bullet[i].bullet_collision_model.x = enemy_bullet[i].bullet_collision_model.y = -100;
            }
